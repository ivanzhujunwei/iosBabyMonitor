...
#pragma mark -
#pragma mark Drawing Behaviour
/**@name Drawing Behaviour */

/** Determintes whether the chart draws flat candlesticks (where open == close).

 Defaults to `NO`.
 */
@property(nonatomic, assign) BOOL showFlatCandlesticks;
