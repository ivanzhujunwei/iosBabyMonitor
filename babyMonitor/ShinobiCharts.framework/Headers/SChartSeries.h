...
/** 
 ...
 <img src="../docs/markdown_files/Images/userguide_lineSeries.png" width=200 alt="Line/Area Series" />
 
 - `SChartScatterSeries` draws data points independently on the chart, with no connections.
 
 <img src="../docs/markdown_files/Images/userguide_scatterSeries.png" width=200 alt="Scatter Series" />
 ...
 <img src="../docs/markdown_files/Images/userguide_bubbleSeries.png" width=100 alt="Bubble Series" />
 
 - `SChartColumnSeries` draws data points as vertical columns on the chart.
 
 <img src="../docs/markdown_files/Images/userguide_columnSeries.png" width=200 alt="Column Series" />
 
 - `SChartBarSeries` draws data points as horizontal bars on the chart.
 
 <img src="../docs/markdown_files/Images/userguide_barSeries.png" width=100 alt="Bar Series" />
 
 - `SChartBandSeries` draws two lines (high and low) and can shade the area between them. ___(Premium Edition only)___.
 
 <img src="../docs/markdown_files/Images/userguide_bandSeries.png" width=200 alt="Band Series" />
 
 - `SChartCandleStickSeries` draws candlestick data points ___(Premium Edition only)___.
 
 <img src="../docs/markdown_files/Images/userguide_candlestickSeries.png" width=200 alt="CandleStick Series" />
 
 - `SChartOHLCSeries` draws Open High Low Close data points ___(Premium Edition only)___.
 
 <img src="../docs/markdown_files/Images/userguide_ohlcSeries.png" width=200 alt="OHLC Series" />
 ...
 <img src="../docs/markdown_files/Images/userguide_steplineSeries.png" width=200 alt="Step Line Series" />
 
 - `SChartPieSeries` draws data points as pie slices around a central point.
 
 <img src="../docs/markdown_files/Images/userguide_pieSeries.png" width=100 alt="Pie Series" />
 
 - `SChartDonutSeries` draws data points as donut slices around a central point.
 
 <img src="../docs/markdown_files/Images/userguide_donutSeries.png" width=100 alt="Donut Series" />
...
- (NSArray SC_GENERIC(NSString *) *)xValueKeys;
...
- (NSArray SC_GENERIC(NSString *) *)yValueKeys;
...
- (NSArray SC_GENERIC(NSString *) *)valueKeys;
