...
- (NSDictionary SC_GENERIC(NSString *, NSString *) *)
     keyValueDisplayPairsForDataPoint:(id<SChartData>) dataPoint
                             onSeries:(SChartSeries*) series
                            withXAxis:(SChartAxis*) xAxis
                            withYAxis:(SChartAxis*) yAxis;
