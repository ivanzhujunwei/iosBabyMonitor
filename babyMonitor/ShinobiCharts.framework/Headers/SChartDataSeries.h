 ...
 */
@property (nonatomic, readonly) NSArray SC_GENERIC(id<SChartData>) *dataPoints;
...
@property (nonatomic, retain) NSArray SC_GENERIC(NSString *) *xValueKeys;
...
@property (nonatomic, retain) NSArray SC_GENERIC(NSString *) *yValueKeys;
...
@property (nonatomic, retain) NSArray SC_GENERIC(NSString *) *valueKeys;
 ...
 */
-(NSArray SC_GENERIC(NSString *) *)allXValues;
